...
install_dnsmasq(){
    ...
    download /tmp/proxy-domains.txt https://raw.githubusercontent.com/kogekiplay/dns-unlock/master/proxy-domains.txt
...
install_sniproxy(){
    ...
    download /tmp/sniproxy-domains.txt https://raw.githubusercontent.com/kogekiplay/dns-unlock/master/proxy-domains.txt
